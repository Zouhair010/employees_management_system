...
def add_employee():
    ...
    list_employee_info = [EmployeeID.get(),Employee_age.get(),Employee_phone.get(),Employee_name.get(),Employee_email.get(),Employee_salary.get()]
    if any( info=='' for info in list_employee_info):
        show_label['fg'] = 'red'
    ...
    if not hash_map.contains(key): #quick check if an employee not to add it exist on file 
        ...
        show_label['fg'] = 'green'
        show_label.config(text=f"{list_employee_info[3]} has been added")

    else: #if the employeer is already on the file
        show_label['fg'] = 'red'
        show_label.config(text=f"{list_employee_info[3]} is already added")
...
window = tk.Tk()
window.iconbitmap("C:\\Users\\dell\\Desktop\\online_information_marketing_social_contact_connection_internet_icon_230574.ico")
...
search_entry.grid(row=0,column=0,pady=(30,10),sticky='nsew',padx=(150,0))
search_entry.grid(row=0,column=1,sticky='nsew',pady=10 ,padx=(80,0))
search_label = tk.Label(frame0, text=" Enter the ID you are searching for ", background='#ceffa4' ,font=('Arial',10,'bold'))
search_label.grid(row=0,column=0)
search_button = tk.Button(frame0, text="search",background='#02a60b',width=20,font=('Arial',9,'bold'),command=search_employee)
search_button.grid(row=0,column=2,pady=(10,10),sticky='nsew',padx=(33,0))

label_frame1 = tk.LabelFrame(frame, text='Employee info',background='#ceffa4',highlightbackground='#ceffa4',highlightthickness=1,font=('Arial',10,'bold'))
label_frame1.grid(row=1,column=0,sticky='nsew')

frame1 = tk.Frame(frame, background='#ceffa4',border=1,relief='groove',highlightbackground='#ceffa4',height=100)
...
list_frame = tk.LabelFrame(frame, text='Employees list',background='#ceffa4',width=980,height=300,border=1,relief="solid",font=('Arial',10,'bold'))
list_frame.grid(row=4,column=0,pady=(0,10),sticky='nsew')

show_label = tk.Label(frame1, text="", background='#ceffa4',width=50,font=('Arial',9,'bold'))
show_label.grid(row=0,column=0,sticky='nsew')

EmployeeID = tk.Entry(label_frame1,width='25',border=1,relief="solid",background='#e1fae6')
...
Employee_age =tk.Entry(label_frame1,width='25',border=1,relief="solid",background='#e1fae6')
...
Employee_phone = tk.Entry(label_frame1,width='25',border=1,relief="solid",background='#e1fae6')
...
Employee_name = tk.Entry(label_frame1,width='25',border=1,relief="solid",background='#e1fae6')
...
Employee_email = tk.Entry(label_frame1,width='25',border=1,relief="solid",background='#e1fae6')
...
Employee_salary = tk.Entry(label_frame1,width='25',border=1,relief="solid",background='#e1fae6')
...
add_button.grid(row=0,column=1,pady=(10),sticky='nsew',padx=(240,10))
remove_button = tk.Button(frame2,background='#02a60b', text="remove",width=20,font=('Arial',9,'bold'),command=remove_employee)
remove_button.grid(row=0,column=2,pady=(10),sticky='nsew',padx=10)
show_button = tk.Button(frame2, text="show",background='#02a60b',width=20,font=('Arial',9,'bold'),command=show_list_employees)
